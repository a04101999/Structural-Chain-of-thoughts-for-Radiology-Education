...
def create_got_prompt_few_shot(experienced_data: dict, inexperienced_data: dict, experienced_time_stamps: dict, inexperienced_time_stamps: dict, ex_experienced_data: dict, ex_inexperienced_data: dict, ex_experienced_time_stamps: dict, ex_inexperienced_time_stamps: dict, ex_correct_output: dict):
    prompt = f"""
...
def run_got_inference(current_batch: dict, all_data: dict, metadata: dict, ex_dicom_id: str, saved_predictions_to_JSON: dict):
    ...
    for K in current_batch.items():
        ...
        prompt = create_got_prompt_few_shot(
...
def main():
    ...
    results_output_file = args.results if args.results else "gpt4o_mini_got_few_shot_results.json"
